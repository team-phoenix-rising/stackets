...
var seedData = function() {
  ...
  .then(() => Language.create({ name: 'elm', displayname: 'Elm' }))
  .then(() => Language.create({ name: 'erlang', displayname: 'Erlang' }))//5
  .then(() => Language.create({ name: 'golang', displayname: 'Go' }))
  .then(() => Language.create({ name: 'handlebars', displayname: 'Handlebars' }))
  .then(() => Language.create({ name: 'html', displayname: 'HTML' }))
  .then(() => Language.create({ name: 'javascript', displayname: 'Javascript' }))
  .then(() => Language.create({ name: 'json', displayname: 'JSON' })) //10
  ...
  .then(() => Language.create({ name: 'php', displayname: 'PHP' })) //15
